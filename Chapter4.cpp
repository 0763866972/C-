...
// chú ý câu lệnh break cũng có thể dùng đc cho for giống switch case  và chức năng nó cũng giống ik vậy lun 
// câu lệnh continue trong dấu ngoặc kép của for hay hiểu là trong cái body code {} khi mà for gặp câu lệnh
// continute nài này thì nó sẽ thực hiện vòng for mới lun 
// nếu for gặp lệnh break thì nó sẽ kết thúc vòng lặp for ngay lặp tức
